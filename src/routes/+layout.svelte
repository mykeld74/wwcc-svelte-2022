...
<svelte:head>
	...
	<link
		href="https://fonts.googleapis.com/css2?family=IBM+Plex+Sans:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;1,100;1,200;1,300;1,400;1,500;1,600;1,700&family=Teko:wght@300;400;500;600;700&display=swap"
		rel="stylesheet"
	/>
	<script>
			...
			<footer>
				...
				<div class="mainFooter">
					...
					<div class="socialContainer">
						<a href="https://www.facebook.com/westwoodscommunitychurch" target="_blank">
						...
						<a href="https://www.instagram.com/westwoodschurch/" target="_blank">
							<svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 24 24"
								><path
									class="icon"
						...
						<a href="https://www.youtube.com/@westwoodscommunitychurch5466" target="_blank">
							<svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 24 24"
								><path
									class="icon"
...
<style lang="scss">
	...
	.socialContainer {
		...
		svg {
			...
			--iconColor: var(--theme-colors-text);
			&:hover {
